...
function makeRecCounter() {
  const KEEP = ["tool_use", "tool_result", "parallel", "expert_start", "expert_done", "error", "limit", "auto_continue", "trim", "compact", "usage", "interject", "credits", "sources", "ask_user", "ask_answer", "milestones"];
