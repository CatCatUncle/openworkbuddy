...
(function (root, factory) {
  ...
  const DICT = {
    en: {
      ...
      "🎚️ 权限档位": "🎚️ Permission level",
      "🛡️ 数据安全": "🛡️ Data security",
      "↺ 跟随全局默认": "↺ Follow global default",
      "⚙️ 管理模型…": "⚙️ Manage models…",
      "该项目还没有任务": "No tasks in this project yet",
      "办公": "Office",
      "命令行": "Terminal",
      "工作线": "Work lane",
      "装它：": "Install it: ",
      "做表、写稿、出图、发消息": "Docs, decks, images, messages",
      "写代码、跑脚本、查日志": "Code, scripts, logs",
      "办公模式": "Office mode",
      "命令行模式": "Terminal mode",
      ...
      "本项目自己的桌面办公 agent：专家团、技能库、记忆、生图生视频都在这条线上，用你配的模型 API 跑": "OpenWorkBuddy's own desktop agent: expert teams, skills, memory, image and video generation — runs on the model API you configured",
      "交给本机装的 Claude Code / Codex 跑，用的是你已经付过的订阅，不再花 API 的钱": "Handed to the Claude Code / Codex installed on this machine, on the subscription you already pay for — no extra API spend",
      ...
      "⚠️ 有零件被跳过：": "⚠️ Some parts were skipped:",
      ...
      "🎙️ 语音合成（TTS）": "🎙️ Speech synthesis (TTS)",
      ...
      "⚙️ 改它的模型 / 换回内置引擎…": "⚙️ Change its model / back to built-in engine…",
      "归档目标（不再显示，也不再按它验收）": "Archive goal (hidden, no longer checked against)",
      "放一两个 emoji，或者上传一张图": "One or two emoji, or upload an image",
      ...
      "用户反馈 · 对话里点的 👍👎（近 30 天）": "User feedback · 👍👎 in chats (last 30 days)",
      ...
      "还没钉基线——点开一次成绩，点「📌 设为基线」，之后每轮自动对比退步/进步": "No baseline pinned. Open a result and click \"📌 Set as baseline\"; later rounds compare against it",
      ...
      "📝 Markdown 直接排版 · 📊 CSV 变表格 · 🌐 HTML 真渲染": "📝 Markdown rendered · 📊 CSV as tables · 🌐 HTML live",
