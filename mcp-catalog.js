...
const ITEMS = [
  // ---- 文件与开发 ----
  std("filesystem", "本地文件", "📁", "读写指定目录里的文件（默认只开放「文稿」目录，参数里可以再加目录）", "文件与开发",
  ...
  std("mysql", "MySQL", "🐬", "查表和跑 SQL（默认只读）", "数据库",
  ...
  std("mongodb", "MongoDB", "🍃", "查集合、聚合、看索引", "数据库",
  ...
  uvx("time", "时间与时区", "🕐", "当前时间、时区换算（要装 uv）", "效率与实验",
    ["mcp-server-time"], { docs: "https://github.com/modelcontextprotocol/servers/tree/main/src/time" }),
  std("everything", "MCP 演示服务器", "🧪", "官方的全功能样例，用来验证连接器链路通不通", "效率与实验",
